...
from igsdk.modbus.modbus_slave import modbus_slave_start
...
modbus_slave_start(port, baudrate, modbus_mode, serial_mode, serial_term, slave_addr, get_read_cb, get_write_cb, set_write_cb)
